...
int mainMenu(void)
{
    ...
    options = "1 ) Add a bank";
    gotoxy(LP + 18, TP + 9);
    printf("%s", options);

    options = "2 ) Delete a bank";
    gotoxy(LP + 18, TP + 11);
    printf("%s", options);

    options = "3 ) View a bank";
    gotoxy(LP + 18, TP + 13);
    printf("%s", options);

    options = "4 ) View all banks";
    gotoxy(LP + 18, TP + 15);
    printf("%s", options);

    options = "5 ) Add a word";
    gotoxy(LP + 18, TP + 17);
    printf("%s", options);

    options = "Edit a word ( 6";
    gotoxy(RP - (20 + strlen(options)), TP + 9);
    printf("%s", options);

    options = "Delete a word ( 7";
...
void deleteWord()
{
    ...
    switch(choice)
    {
        case 1:
            ...
            gotoxy(LP + 4, TP + 25);
    		printf("All words has been successfully deleted");
    		fflush(stdin);
    		getchar();
    		while(1){
                fflush(stdin);
